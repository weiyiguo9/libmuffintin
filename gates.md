...
| G-CTF-R1 | `ctf-rs` | every D1 to D6 acceptance driver after the rsmpi binding change, class R | pinned cc4s/ctf `f69cbb46` | upstream tolerance, unchanged | ctf-rs `docs/validation.md` "rsmpi binding"; `scripts/acceptance-wsl.sh` 1/2/4 once; native build once; D6 native set once | accepted, evt-0054 |
