...
use crate::thc::linalg::{column_pivots, hermitian_sqrt, pivoted_cholesky_pivots};
        ...
        for ik in 0..n_k {
            ...
            for (p, point) in points.iter().enumerate() {
                let phase = if q0_only {
                    ...
                    crate::thc::kmesh::umklapp_phase(*point, shift, mesh.lattice_constant())
                };
                for s in 0..sketch {
...
fn coulomb_rerank(
    ...
    for iq in 0..mesh.len() {
        ...
        let y_len = crate::thc::error::checked_storage_len(&[n, n_pool])?;
    ...
    let stacked_len = crate::thc::error::checked_storage_len(&[n_row, n_pool])?;
