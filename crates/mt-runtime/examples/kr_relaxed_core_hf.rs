...
struct IterationRecord {
    ...
    fresh_core_assembly_residual: f64,
    valence_only_mixing_residual: Option<f64>,
...
struct ResidualRecord {
    ...
    first_one_shot_parity: Option<f64>,
    fresh_core_replacement_rms: f64,
    fresh_core_assembly: f64,
    valence_only_mixing: Option<f64>,
...
fn iteration_record(item: &RelaxedCoreHfIterationDiagnostic) -> IterationRecord {
    IterationRecord {
        ...
        first_one_shot_parity_residual: item.first_one_shot_parity_residual,
        fresh_core_replacement_rms: item.fresh_core_replacement_rms,
        fresh_core_assembly_residual: item.fresh_core_assembly_residual,
        valence_only_mixing_residual: item.valence_only_mixing_residual,
...
fn result_record(result: &RelaxedCoreHfResult) -> ResultFile {
    ...
    ResultFile {
        ...
        residuals: ResidualRecord {
            ...
            first_one_shot_parity: final_iteration.first_one_shot_parity_residual,
            fresh_core_replacement_rms: final_iteration.fresh_core_replacement_rms,
            fresh_core_assembly: final_iteration.fresh_core_assembly_residual,
            valence_only_mixing: final_iteration.valence_only_mixing_residual,
