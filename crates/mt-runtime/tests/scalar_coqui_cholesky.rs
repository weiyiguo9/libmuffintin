...
use muffintin::{
    ...
    ScalarCoulombError, ScalarCoulombResult, ScalarProductInput, SnapshotDftPhysics,
...
use scalar_hydrogen::{coulomb_spec, hydrogen_snapshot, parent_grid, scalar_config, thc_spec};
