...
use muffintin::{
    ...
    ScalarCoulombSpec, ScalarMpbSelection, ScalarMpbSpec, ScalarProductInput, ScalarThcCandidates,
    ScalarThcEngine, ScalarThcGrid, ScalarThcPoint, ScalarThcRegion, ScalarThcSpec,
    SnapshotDftPhysics, build_scalar_coulomb, build_scalar_mpb, build_scalar_thc,
};
...
fn selected_nodes_or_permuted_parent_rows_fail_context_or_oracle() {
    ...
    let selected = truncated
        ...
        .collect::<Vec<_>>();
    truncated.grid = ScalarThcGrid::new(
