...
with a scale-relative companion.  Forming $S^{-1}H$ is forbidden: it
...
potential and basis parameters.  Therefore the real Cu $\le 1\,\mathrm{meV}$ gate remains
...
- the SPEX spherical $2 \times 2$ radial identity above;
