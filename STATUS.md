...
- Last ledger entry: evt-0007 (2026-09-08)

| Workstream | State | Plan | Notes |
|---|---|---|---|
| `ctf-rs` | proposed | `plans/ctf-rs/plan.v1.md`, proposed | plan.v1 dense-first; per-run evidence stays in ctf-rs docs/validation.md |
