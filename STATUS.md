...
- Last ledger entries: evd-1019 (MSI), evt-1011 (MSI), evd-0025 (Mac), evt-0076 (Mac)

| Workstream | State | Plan | Notes |
|---|---|---|---|
| `ctf-rs` | plan.v5 closed on macOS (G-CTF-A1 PASS, evd-0025); port scope complete and audited; origin/master = b87301a; WSL and native reruns pending on MSI | `plans/ctf-rs/plan.v5.md`, accepted 2026-09-12 | open: MSI reruns of plan.v5 section 1, clippy style classes, ctf-tiled T1 decision |
