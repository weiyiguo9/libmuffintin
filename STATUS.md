...
- Last ledger entries: evd-1017 (MSI), evt-1008 (MSI), evd-0024 (Mac), evt-0067 (Mac)

| Workstream | State | Plan | Notes |
|---|---|---|---|
| `ctf-rs` | C1/S1b closed; S1a recorded with three HANDOFF drivers; S1c active | `plans/ctf-rs/plan.v3.md`, accepted 2026-09-11 | evd-1017; local 26af71f; four S1b targets WSL 1/2/4 and native build PASS; final thirteen-target native S1 runtime remains required |
